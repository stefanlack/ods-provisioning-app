...
public class RestClient {
  ...
  private <T> T callHttpInternal(
    ...
    if (directAuth) {
      ...
      String credentials = Credentials.basic(currentUser, manager.getUserPassword());
  ...
  public void callHttpBasicFormAuthenticate(String url) throws IOException {
    ...
    // TODO stefan lack: check following 4 commented lines/replacment
    ...
    String username = "opendevstack.admin";
